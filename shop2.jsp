<%-- 
    Document   : shop2
    Created on : 30 Oct, 2022, 8:57:10 PM
    Author     : hp
--%>
...
<body onload="noBack();" onpageshow="if(event.presisted) noBack();">
    ...
    <%
        ...
        response.setHeader("Cache-Control", "must-revalidate");
            ...
            String amount = "";
            String pid = " ";
            ResultSet rs = st.executeQuery("Select * from costume ORDER BY RAND() LIMIT 12");
    %>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3">         
                    <div class="header__logo">
                        <a href="./index.html"><img src="img/logo4.jpg" alt="" height="30 px"></a>
                    </div>
                </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" >
                                    <img src="img.jsp?imgid=<%=pid%>" height="260px" width="260px">
                                ...
                                <div class="product__item__text">
                                    <h6><%=name%></h6>
                                    <a href="dress.jsp?pid=<%=pid%>" class="add-cart">+ Add To Cart</a>
                                    <div class="rating">
                                    ...
                                    <div class="product__color__select">
                                        <form method="post" action="dress2.jsp">
